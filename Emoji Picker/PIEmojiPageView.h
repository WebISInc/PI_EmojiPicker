...
@protocol PIEmojiPageViewDelegate;


@interface PIEmojiPageView : NSView
@property (nonatomic, assign) id<PIEmojiPageViewDelegate> delegate;
...
@protocol PIEmojiPageViewDelegate <NSObject>
